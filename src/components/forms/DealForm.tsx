...
export default function DealForm({ leads, stages }: Props) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            setError(err.message || 'Ocorreu um erro ao criar o negócio.')
            setLoading(false)
        }
    }
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-xs font-medium text-gray-400 uppercase tracking-widest mb-4">
                ...
                <span>/</span>
                <span className="text-gray-900">Novo Negócio</span>
            </div>

            <div className="mb-10">
                <h1 className="text-2xl font-bold text-gray-900">Novo Negócio</h1>
                <p className="text-sm text-gray-400 mt-1">Vinculado a um lead e com ação obrigatória.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-8">
                {/* Sessão 1: Informações do Negócio */}
                <section className="bg-white border border-gray-100 rounded-2xl p-6 space-y-4">
                    <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wider border-b border-gray-50 pb-3 mb-4">Detalhes da Oportunidade</h2>

                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Título do Negócio *</label>
                        <input
                            name="title"
                            required
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Lead / Cliente *</label>
                            <select
                                name="leadId"
                                required
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Valor Estimado</label>
                            <input
                                name="estimatedValue"
                                type="number"
                                step="0.01"
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Estágio Inicial *</label>
                        <select
                            name="stageId"
                            required
